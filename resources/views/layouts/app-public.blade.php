...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="keywords" content="ecommerce,drone">
        <meta name="author" content="422023020 - Peter Andrian Priestley">

        <title>@yield('title') | 422023020 - Peter Andrian Priestley</title>
